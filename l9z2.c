...
/*/
2)	Program, jak powy¿ej. Dodatkowo, po starcie program wyœwietli pobierane znaki w górnej linii zaczynaj¹c od lewej. 
Po osi¹gniêciu przez kursor
ostatniej wyœwietlanej pozycji w górnej linii kursor zatrzymuje siê, natomiast ka¿de wprowadzenie kolejnego znaku przesuwa 
dotychczasow¹ treœæ o 1 pozycjê w lewo.
Ponadto, przytrzymywanie klawisza "Clear" ponad 1s (dla testowania na emulatorze skróciæ 10 krotnie) czyœci wyœwietlacz 
i prze³¹cza do wyœwietlania w 2-iej linii.
/*/
